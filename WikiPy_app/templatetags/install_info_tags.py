...
@register.inclusion_tag('WikiPy_app/tags/install-info-resource-table.html', takes_context=True)
...
@register.inclusion_tag('WikiPy_app/tags/install-info-parser-features-table.html', takes_context=True)
