...
def _get_base_page_context(namespace_id: int, title: str, mode: str, user: models.User, noindex: bool,
    ...
    return page_context.PageContext(
        ...
        main_page_title_url=api.as_url_title(settings.MAIN_PAGE_TITLE),
        main_page_full_title=main_page_full_title,
        main_page_full_title_url=api.as_url_title(main_page_full_title),
        page_title=title,
        page_title_url=api.as_url_title(title),
        full_page_title=full_title,
        full_page_title_url=api.as_url_title(full_title),
        namespace_id=namespace_id,
        canonical_namespace_name=canonical_ns,
        canonical_namespace_name_url=api.as_url_title(canonical_ns),
        namespace_name=ns_name,
        namespace_name_url=api.as_url_title(ns_name),
        mode=mode,
        noindex=noindex,
