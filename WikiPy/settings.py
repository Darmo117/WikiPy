"""
Django settings for WikiPy project.
...
SECRET_KEY = '!zy_6he!@*(3!ibvnu9&tfnupeu0#i64k*nd0z5&#pmrxag#sb'
...
WSGI_APPLICATION = 'WikiPy.wsgi.application'
